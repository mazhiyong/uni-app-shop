		...
		<view class="cover-container" :style="[{
		 ...
		 @touchstart="coverTouchstart" @touchmove="coverTouchmove" @touchend="coverTouchend">
			...
			<view class="order-section">
				<view class="order-item" @click="navTo('/pages/order/ygc_refresh_order?state=0')" hover-class="common-hover" :hover-stay-time="50">
			...
			<view class="history-section icon">
				...
				<list-cell icon="icon-dizhi" iconColor="#aa0000" title="网络请求测试" @eventClick="navTo('/pages/network/networkTest')"></list-cell>
			</view>
		</view>
